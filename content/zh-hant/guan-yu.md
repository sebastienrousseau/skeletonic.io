...
<p class="badges">
  ...
  <img alt="套件大小" src="https://img.shields.io/badge/gzipped-7.5%20KB-brightgreen?style=for-the-badge" height="28" loading="lazy">
...
<div class="feature-grid">
  ...
  <article class="feature-card">
    ...
    <h3>輕量級</h3>
    <p>gzip 後約 7.5&nbsp;KB。頁面載入更快。每個必要的建構模組一應俱全。</p>
  </article>
...
|---|---|---|---|---|
| gzip 大小 | **約 7.5&nbsp;KB** | 約 30&nbsp;KB | 約 10&nbsp;KB (varies) | 約 30&nbsp;KB |
