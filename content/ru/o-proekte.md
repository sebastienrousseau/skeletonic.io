...
<p class="badges">
  ...
  <img alt="Размер бандла" src="https://img.shields.io/badge/gzipped-7.5%20KB-brightgreen?style=for-the-badge" height="28" loading="lazy">
...
<div class="feature-grid">
  ...
  <article class="feature-card">
    ...
    <h3>Легковесность</h3>
    <p>~7,5&nbsp;КБ в gzip. Страницы загружаются быстрее. Все основные строительные блоки на месте.</p>
  </article>
...
|---|---|---|---|---|
| Размер в gzip | **~7,5&nbsp;КБ** | ~30&nbsp;КБ | ~10&nbsp;КБ JIT | ~30&nbsp;КБ |
