...
带有语义意图的状态消息。**在 v1.1.7 中，每个变体均显式命名空间化**为 `.alert-{primary,secondary,info,success,warning,error}`，因此变体类不会与页面其他地方的状态类冲突。
...
<script type="application/ld+json">
{
  ...
  "description": "Skeletonic Stylus v1.1.7 中的所有组件。",
