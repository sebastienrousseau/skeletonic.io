...
(8.0&nbsp;KB gzipped fun iwe-aṣa akọkọ), o darapọ mọ ohun elo wẹẹbu
...
|---|---|---|
| `core/skeletonic.min.css` | Atunṣeto + awọn ami + eto + awọn ẹya + awọn paati + awọn iwulo | 40.6 KB / 8.0 KB |
...
**Kini iwọn gzipped?**
40.6&nbsp;KB minified, **8.0&nbsp;KB gzipped**, 6.9&nbsp;KB brotli fun
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "40.6 KB minified, 8.0 KB gzipped, 6.9 KB brotli fun iwe-aṣa akọkọ ni kikun. Opin 8 KB ni a fi ipa mu ninu CI lori gbogbo adehun."
      }
    },
    {
      "@type": "Question",
