...
<p class="badges">
  ...
  <img alt="번들 크기" src="https://img.shields.io/badge/gzipped-7.5%20KB-brightgreen?style=for-the-badge" height="28" loading="lazy">
...
<div class="feature-grid">
  ...
  <article class="feature-card">
    ...
    <h3>경량</h3>
    <p>약 7.5&nbsp;KB gzipped. 페이지가 더 빠르게 로드됩니다. 모든 필수 구성 요소가 포함되어 있습니다.</p>
  </article>
...
|---|---|---|---|---|
| Gzipped 크기 | **약 7.5&nbsp;KB** | 약 30&nbsp;KB | 약 10&nbsp;KB (varies) | 약 30&nbsp;KB |
