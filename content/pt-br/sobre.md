...
<p class="badges">
  ...
  <img alt="Tamanho do Bundle" src="https://img.shields.io/badge/gzipped-7.5%20KB-brightgreen?style=for-the-badge" height="28" loading="lazy">
...
<div class="feature-grid">
  ...
  <article class="feature-card">
    ...
    <h3>Leve</h3>
    <p>~7,5&nbsp;KB gzipped. As paginas carregam mais rapido. Todos os blocos essenciais permanecem incluidos.</p>
  </article>
...
|---|---|---|---|---|
| Tamanho gzipped | **~7,5&nbsp;KB** | ~30&nbsp;KB | ~10&nbsp;KB (varies) | ~30&nbsp;KB |
...
| **Patch** | Correcoes de bugs, ajustes de a11y, performance, seguranca | 1.1.6 → 1.1.7 |
