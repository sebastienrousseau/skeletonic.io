...
<p class="badges">
  ...
  <img alt="Розмір пакета" src="https://img.shields.io/badge/gzipped-7.5%20KB-brightgreen?style=for-the-badge" height="28" loading="lazy">
...
<div class="feature-grid">
  ...
  <article class="feature-card">
    ...
    <h3>Легкість</h3>
    <p>~7,5&nbsp;КБ gzip. Сторінки завантажуються швидше. Усі необхідні будівельні блоки на місці.</p>
  </article>
...
|---|---|---|---|---|
| Розмір gzip | **~7,5&nbsp;КБ** | ~30&nbsp;КБ | ~10&nbsp;КБ JIT | ~30&nbsp;КБ |
