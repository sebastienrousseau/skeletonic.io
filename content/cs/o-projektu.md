...
<p class="badges">
  ...
  <img alt="Velikost balicku" src="https://img.shields.io/badge/gzipped-7.5%20KB-brightgreen?style=for-the-badge" height="28" loading="lazy">
...
<div class="feature-grid">
  ...
  <article class="feature-card">
    ...
    <h3>Lehke</h3>
    <p>~7,5&nbsp;KB gzipped. Stranky se nacitaji rychleji. Kazdy zakladni stavebni blok zustava.</p>
  </article>
...
|---|---|---|---|---|
| Velikost gzipped | **~7,5&nbsp;KB** | ~30&nbsp;KB | ~10&nbsp;KB (varies) | ~30&nbsp;KB |
...
| **Patch** | Opravy chyb, vylepseni pristupnosti, vykon, bezpecnost | 1.1.6 → 1.1.7 |
