...
<p class="badges">
  ...
  <img alt="גודל חבילה" src="https://img.shields.io/badge/gzip-7.8%20KB-brightgreen?style=for-the-badge" height="28" loading="lazy">
...
<div class="feature-grid">
  ...
  <article class="feature-card">
    ...
    <h3>קלת משקל</h3>
    <p>כ-7.8&nbsp;KB בדחיסת gzip. הדפים נטענים מהר יותר. כל אבן בניין חיונית נשארת.</p>
  </article>
...
|---|---|---|---|---|
| גודל gzip | **כ-7.8&nbsp;KB** | כ-30&nbsp;KB | כ-10&nbsp;KB (varies) | כ-30&nbsp;KB |
